...
class Relevatracking_Admin
{
    ...
    public function enqueue_scripts()
    {
        ...
        wp_localize_script($this->plugin_name, $this->plugin_name . '_opt', array(
            ...
            'dialog_received' => __('If you already registered, you can find your API Key in your account and enter it:', $this->plugin_name),
            'dialog_register' => __('<a href="https://releva.nz" target="_blank">Did not register yet? Get started now!</a>', $this->plugin_name),
